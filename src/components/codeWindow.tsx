...
>>>>>>> b294fd59b8fd42ecec83f234503a528ebf281014
      ...
      {/* Code */}
      <pre
        className="overflow-x-auto rounded-lg rounded-tl-none border border-stone-200 bg-stone-100 p-2 text-sm text-primary dark:border-muted dark:bg-stone-800 dark:text-onPrimary"
